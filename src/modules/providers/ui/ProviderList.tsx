...
export function ProviderList() {
  ...
  // No redundant empty state: with zero providers this page IS the add form,
  // so the list simply isn't there. The section owns its heading so an empty
  // list leaves no dangling "Providers" label.

...
export function Switch({
  ...
  return (
    <BaseSwitch.Root
      ...
      className="relative h-5 w-9 shrink-0 cursor-pointer rounded-full bg-neutral-300 transition-colors focus-visible:ring-2 focus-visible:ring-brand-500 focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-40 data-[checked]:bg-brand-600 dark:bg-neutral-700 dark:data-[checked]:bg-brand-500"
    >

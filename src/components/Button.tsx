...
type Variant = "primary" | "danger" | "ghost" | "ghost-danger" | "outline" | "choice";
type Size = "sm" | "md";

const VARIANTS: Record<Variant, string> = {
  primary: "bg-brand-600 text-brand-950 hover:bg-brand-700",
  ...
  // composer, filling toward the user bubble's own cyan as you commit to it.
  choice:

...
const VARIANTS: Record<Variant, string> = {
  ...
  nav: "text-neutral-600 hover:bg-neutral-100 aria-[current=page]:bg-brand-50 aria-[current=page]:text-brand-800 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:aria-[current=page]:bg-brand-950/60 dark:aria-[current=page]:text-brand-200",
};

...
export function ZoomableImage({
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Backdrop className="fixed inset-0 z-50 bg-black/70 dark:bg-black/80" />
        <Dialog.Popup className="fixed top-1/2 left-1/2 z-50 max-w-[calc(100vw-2rem)] -translate-x-1/2 -translate-y-1/2">
          <img
            src={src}
            alt={alt}
